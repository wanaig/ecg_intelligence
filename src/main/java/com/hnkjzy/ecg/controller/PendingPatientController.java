...
@RestController
@RequestMapping("/api/pending-patients")
/**
 * 类说明：PendingPatientController。
...
public class PendingPatientController {
    ...
    public PendingPatientController(EcgBusinessService ecgBusinessService) {
    ...
    public ApiResponse<List<PatientManageView>> list() {
        return ApiResponse.success(ecgBusinessService.listPendingPatients());
    }
}
